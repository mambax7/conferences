 ...
 */
function xoops_module_pre_update_conferences(\XoopsModule $module)
{
    ...
    /** @var \XoopsModules\Conferences\Common\Configurator $configurator */
    ...
    //    $migrator = new \XoopsModules\Conferences\Common\Migrate();
...
function xoops_module_update_conferences(\XoopsModule $module, $previousVersion = null)
{
    $moduleDirName = basename(dirname(__DIR__));
    //$moduleDirNameUpper = mb_strtoupper($moduleDirName);

    /** @var Conferences\Helper $helper */ /** @var Conferences\Utility $utility */
    /** @var Conferences\Common\Configurator $configurator */
    $helper       = Conferences\Helper::getInstance();
    $utility      = new Conferences\Utility();
    $configurator = new Conferences\Common\Configurator();
