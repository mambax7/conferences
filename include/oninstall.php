 ...
 */
function xoops_module_pre_install_conferences(\XoopsModule $module)
{
 ...
 */
function xoops_module_install_conferences(\XoopsModule $module)
{
    $moduleDirName = basename(dirname(__DIR__));

    /** @var \XoopsModules\Conferences\Helper $helper */ /** @var \XoopsModules\Conferences\Utility $utility */
