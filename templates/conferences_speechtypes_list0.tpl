...
<div class="panel panel-info">
    <div class="panel-heading"><h2 class="panel-title"><strong>Speechtypes</strong></h2></div>

    <table class="table table-striped">
        <thead>
        <tr>
            <th><{$smarty.const.MD_CONFERENCES_SPEECHTYPES_ID}></th>
            <th><{$smarty.const.MD_CONFERENCES_SPEECHTYPES_NAME}></th>
            <th><{$smarty.const.MD_CONFERENCES_SPEECHTYPES_COLOR}></th>
            <th><{$smarty.const.MD_CONFERENCES_SPEECHTYPES_PLENARY}></th>
            <th><{$smarty.const.MD_CONFERENCES_SPEECHTYPES_LOGO}></th>
            <th width="80"><{$smarty.const.MD_CONFERENCES_ACTION}></th>
        </tr>
        </thead>
        <{foreach item=speechtypes from=$speechtypes}>
            <tbody>
            <tr>
                ...
                <td><img src="<{$xoops_url}>/uploads/conferences/speechtypes/<{$speechtypes.logo}>" style="max-width:100px" alt="speechtypes"></td>
                <td>
