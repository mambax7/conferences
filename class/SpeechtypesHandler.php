...
/**
 * Class SpeechtypesHandler
 */
class SpeechtypesHandler extends \XoopsPersistableObjectHandler
{
    /**
     * @var Helper
     */
    ...
    public function __construct(\XoopsDatabase $db = null, $helper = null)
    {
        ...
        $this->helper = $helper;
        parent::__construct($db, 'conferences_speechtypes', Speechtypes::class, 'id', 'name');
    }
