 ...
 * Class Conference
 */
class Conference extends \XoopsObject
{
    ...
    public function __construct()
    {
        ...
        $this->initVar('subsubtitle', XOBJ_DTYPE_TXTBOX);
        $this->initVar('sdate', XOBJ_DTYPE_INT);
        $this->initVar('edate', XOBJ_DTYPE_INT);
        $this->initVar('summary', XOBJ_DTYPE_OTHER);
        $this->initVar('isdefault', XOBJ_DTYPE_INT);
     ...
     *
     * @param null
     * @return Conferences\Form\ConferenceForm
     */
    public function getForm()
    {
        $form = new Form\ConferenceForm($this);
        return $form;
    }
