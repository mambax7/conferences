<div id="help-template" class="outer">
    <{include file=$smarty.const.MI_CONFERENCES_HELP_HEADER}>
    ...
    <p class="even">
        Tutorial has been started, but we might need your help! Please check out the status of the tutorial <a href="https://xoops.gitbook.io/conferences-tutorial/" target="_blank">here </a>.
        <br><br>To contribute to this Tutorial, <a href="https://github.com/XoopsDocs/conferences-tutorial/" target="_blank">please fork it on GitHub</a>.
    ...
    <p class="even">
        This module is Open Source and we would love your help in making it better! You can fork this module on <a href="https://github.com/XoopsModules25x/conferences" target="_blank">GitHub</a><br><br>
